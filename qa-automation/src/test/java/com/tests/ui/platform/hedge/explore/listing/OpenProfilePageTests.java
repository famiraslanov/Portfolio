...
public class OpenProfilePageTests extends HedgeMain
{

    @CoverageInfo(details = "Verify open profile page from listing")
    @Test
    public void openProfilePageTest()
    {
        ...
        ProfilePage profilePage = entityListingPage.clickOnRowByName(profileFirst);
        profilePage.verifyThatSelectedProfileIsOpen(profileFirst);
    }
}
